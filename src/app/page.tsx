...
export default async function HomePage() {
  ...
  return <DashboardShell courseName={displayCourseName(section.courseName, section.courseCode)} schoolYear={section.schoolYearLabel} sectionName={section.sectionName} studentCount={roster.length} dataMode="Live Supabase roster"/>;
}
